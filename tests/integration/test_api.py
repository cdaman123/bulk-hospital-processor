...
def test_bulk_upload_success(client, mocker):
    mocker.patch("app.core.hospital_client.HospitalDirectoryClient.create_hospital", return_value={"id": 1})
    mocker.patch("app.core.hospital_client.HospitalDirectoryClient.activate_batch", return_value=None)
